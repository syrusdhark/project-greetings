...
-- Update all RLS policies to include passholder with combined admin/super_admin permissions
...
-- Allow passholders to manage testimonials and water sports providers
